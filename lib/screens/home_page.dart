...
class _HomePageState extends State<HomePage> {
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  builders_Page()),
                        );
                      },
                    ),
                  ),
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => tilers_Page()),
                        );
                      },
                    ),
                  ),
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  archicts_Page()),
                        );
                      },
                    ),
                  ),
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  plumbers_Page()),
                        );
                      },
                    ),
                  ),
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  civilEngineers_Page()),
                        );
                      },
                    ),
                  ),
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  painters_Page()),
                        );
                      },
                    ),
                  ),
        ...
        SizedBox(
          ...
          child: Padding(
            ...
            child: ListView(
              ...
              children: <Widget>[
                headerCategoryItem(
                    'Calculator', FontAwesomeIcons.calculator, Colors.red,
                    onPressed: () {
                ...
                headerCategoryItem('Guide', FontAwesomeIcons.book, Colors.red,
                    onPressed: () {
  ...
  Widget headerCategoryItem(String name, IconData icon, Color color, {onPressed}) {
    return Container(
